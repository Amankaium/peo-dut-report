...
class DeltaReport(models.Model):
    month_report = models.ForeignKey(MonthReport, models.CASCADE, null=True)
    ...
    fact_km = models.DecimalField(max_digits=10, decimal_places=2, verbose_name="Факт КМ", null=True)
    ...
    start_balance = models.DecimalField(max_digits=10, decimal_places=2, verbose_name="Остаток на начало", null=True)
    start_level = models.DecimalField(max_digits=10, decimal_places=2, verbose_name="Нач. уровень", null=True, blank=True)
    fueling_gsm = models.DecimalField(max_digits=10, decimal_places=2, verbose_name="Заправка ГСМ", null=True)
    total_refueled = models.DecimalField(max_digits=10, decimal_places=2, verbose_name="Всего заправлено", null=True, blank=True)
    actual_fuel_consumption = models.DecimalField(max_digits=10, decimal_places=2, verbose_name="Факт Расход топлива (литр)", null=True)
    norm_fuel_consumption = models.DecimalField(max_digits=10, decimal_places=2, verbose_name="Норма Расход топлива (литр)", null=True)
    ...
    fuel_calculation_norm = models.DecimalField(max_digits=10, decimal_places=2, verbose_name="Калькуляция нормы расхода", null=True)
    departure_balance = models.DecimalField(max_digits=10, decimal_places=2, verbose_name="Остаток по пут.листу", null=True)
    ...
    end_mech_balance = models.DecimalField(max_digits=10, decimal_places=2, verbose_name="Остаток кон.мех.", null=True)
    difference = models.DecimalField(max_digits=10, decimal_places=2, verbose_name="Разница", null=True, blank=True)
    deficiency = models.DecimalField(max_digits=10, decimal_places=2, verbose_name="Недостача/Излишек", null=True)
